...
class ChEBIOverXSPEChEMBL(ChEBIOverX):
    """
    A class for extracting data from the ChEBI dataset with the pretrained SPE reader on ChEMBL.
...
class ChEBIOverXSPEChEBI(ChEBIOverX):
    """
    A class for extracting data from the ChEBI dataset with the pretrained SPE reader on ChEBI.

    Inherits from ChEBIOverX.

    Attributes:
        READER (ChemSPEChEBIReader): The reader used for reading the dataset (SPE, bundled spe_chebi codes).
    """

    READER: dr.SPEChEBIReader = dr.SPEChEBIReader
...
class ChEBIOverXAPEChEMBL(ChEBIOverX):
    """
    A class for extracting data from the ChEBI dataset with the pretrained APE reader on ChEMBL.

    Inherits from ChEBIOverX.

    Attributes:
        READER (APEChEMBLReader): The reader used for reading the dataset (APE, bundled ape_chembl vocab).
    """
...
class ChEBIOverXTrieChEMBL(ChEBIOverX):
    """
    A class for extracting data from the ChEBI dataset with the pretrained Trie reader trained on ChEMBL.

    Inherits from ChEBIOverX.

    Attributes:
        READER (TrieChEMBLReader): The reader used for reading the dataset (Trie, bundled trie_chembl).
    """

    READER: dr.TrieChEMBLReader = dr.TrieChEMBLReader


class ChEBIOverXTrieChEBI(ChEBIOverX):
    """
    A class for extracting data from the ChEBI dataset with the pretrained Trie reader trained on ChEBI.

    Inherits from ChEBIOverX.

    Attributes:
        READER (TrieChEBIReader): The reader used for reading the dataset (Trie, bundled trie_chebi).
    """

    READER: dr.TrieChEBIReader = dr.TrieChEBIReader
...
class ChEBIOverXTrieTTGChEMBL(ChEBIOverX):
    """
    A class for extracting data from the ChEBI dataset with the pretrained TTG-refined Trie reader trained on ChEMBL.

    Inherits from ChEBIOverX.

    Attributes:
        READER (TrieTTGChEMBLReader): The reader used for reading the dataset (Trie+TTG, bundled ttg_chembl).
    """

    READER: dr.TrieTTGChEMBLReader = dr.TrieTTGChEMBLReader


class ChEBIOverXTrieTTGChEBI(ChEBIOverX):
    """
    A class for extracting data from the ChEBI dataset with the pretrained TTG-refined Trie reader trained on ChEBI.

    Inherits from ChEBIOverX.

    Attributes:
        READER (TrieTTGChEBIReader): The reader used for reading the dataset (Trie+TTG, bundled ttg_chebi).
    """

    READER: dr.TrieTTGChEBIReader = dr.TrieTTGChEBIReader
...
class ChEBIOver50SPEChEMBL(ChEBIOverXSPEChEMBL, ChEBIOver50):
    """
    A class for extracting data from the ChEBI dataset with the ChEMBL-trained SPE reader and a threshold of 50.

    Inherits from ChEBIOverXSPEChEMBL and ChEBIOver50.
    """

    pass


class ChEBIOver50SPEChEBI(ChEBIOverXSPEChEBI, ChEBIOver50):
    """
    A class for extracting data from the ChEBI dataset with the ChEBI-trained SPE reader and a threshold of 50.

    Inherits from ChEBIOverXSPEChEBI and ChEBIOver50.
    """
...
class ChEBIOver50APEChEMBL(ChEBIOverXAPEChEMBL, ChEBIOver50):
    """
...
class ChEBIOver50TrieChEMBL(ChEBIOverXTrieChEMBL, ChEBIOver50):
    """
    A class for extracting data from the ChEBI dataset with the ChEMBL-trained Trie reader and a threshold of 50.

    Inherits from ChEBIOverXTrieChEMBL and ChEBIOver50.
    """

    pass


class ChEBIOver50TrieChEBI(ChEBIOverXTrieChEBI, ChEBIOver50):
    """
    A class for extracting data from the ChEBI dataset with the ChEBI-trained Trie reader and a threshold of 50.

    Inherits from ChEBIOverXTrieChEBI and ChEBIOver50.
    """
...
class ChEBIOver100TrieTTGChEMBL(ChEBIOverXTrieTTGChEMBL, ChEBIOver100):
    """
    A class for extracting data from the ChEBI dataset with the ChEMBL-trained Trie+TTG reader and a threshold of 100.

    Inherits from ChEBIOverXTrieTTGChEMBL and ChEBIOver100.
    """

    pass


class ChEBIOver50TrieTTGChEMBL(ChEBIOverXTrieTTGChEMBL, ChEBIOver50):
    """
    A class for extracting data from the ChEBI dataset with the ChEMBL-trained Trie+TTG reader and a threshold of 50.

    Inherits from ChEBIOverXTrieTTGChEMBL and ChEBIOver50.
    """

    pass


class ChEBIOver50TrieTTGChEBI(ChEBIOverXTrieTTGChEBI, ChEBIOver50):
    """
    A class for extracting data from the ChEBI dataset with the ChEBI-trained Trie+TTG reader and a threshold of 50.

    Inherits from ChEBIOverXTrieTTGChEBI and ChEBIOver50.
    """
